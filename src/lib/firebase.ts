...
// Critical: specify firestoreDatabaseId for custom provisioned databases
...
// Error handling types and helpers as mandated by Firebase skill
...
// Google Sign-In helper using popup (recommended for iframe/sandbox preview)
