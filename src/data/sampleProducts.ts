...
export const INITIAL_METADATA: RFQMetadata = {
  ...
  instructionsEn: 'Please provide your best FOB Ningbo/Shenzhen prices based on target quantities. Include complete master carton packing specs (dimensions, gross weight, units/carton) and lead times.',
  instructionsZh: '尊敬的供应商：请根据预计采购量报出最优惠的FOB离岸价及EXW出厂价，并详细填写装箱数、外箱尺寸、单箱毛重和大货交期。',
};
...
export const SAMPLE_PRODUCTS: ProductItem[] = [
  ...
  },
  {
    ...
    values: {
      ...
      sampleCost: 'Free existing sample (3 days)',
  ...
  },
  {
    ...
    values: {
      ...
      leadTime: 35,
      portOfLoading: 'Shenzhen',
      sampleCost: '$45 with buyer logo (7 days)',
